...
%% EDA - Run CDA Batch analysis with Ledalab package
...
% NOTE
% copy the contents of leda_in/ to leda_cda/
% then run a copy of this script inside leda_cda/
% easiest way to apply batch analysis with Ledalab
%   (Ledalab spits out result files in pwd...)


%% Apply Batch Analysis - CDA method
% Continuous Decomposition Analysis
% useful method "for unbiased scores of tonic & phasic activity"
...
Ledalab(pwd,'open','mat','analyze','CDA','optimize',3,...
