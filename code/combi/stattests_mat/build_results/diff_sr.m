...
tbl.pval = cell(3,1);
tbl.pFDR = cell(3,1);
tbl.varnames = {'p1','p2','p3','q1','q2','q3'};
tbl.rownames = log.ftr_names;



%% Stress response at baseline
% pre-treatment, no separation of treatment groups.
...
tbl_mat = table(tbl.pval{1},tbl.pval{2},tbl.pval{3},...
                tbl.qval{1},tbl.qval{2},tbl.qval{3},...
...
input.tableColumnAlignment = 'rllllll';
...
alt.varnames.test = {'all','oxytocin','placebo'};
