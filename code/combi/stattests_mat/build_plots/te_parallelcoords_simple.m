...
for c = 1:nb_cols                        % use nb_cols if transposed
    r = find(contains(figrows,gethere)); % use figrows if transposed
    samples{r,c} = test.sample{ftrx{c}}; % use c if transposed 
end
